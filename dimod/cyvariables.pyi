...
class cyVariables:
    def __init__(self, iterable: typing.Optional[collections.abc.Iterable[Variable]] = None): ...
    ...
    def __iter__(self) -> collections.abc.Iterator[Variable]: ...
    def __len__(self) -> int: ...
    def _append(self, v: typing.Optional[Variable] = None, permissive: bool = False) -> Variable: ...
    def _clear(self) -> None: ...
    def _is_range(self) -> bool: ...
    def _extend(self, iterable: collections.abc.Iterable[Variable], permissive: bool = False) -> None: ...
    def _pop(self) -> Variable: ...
    def _relabel(self, mapping: collections.abc.Mapping[Variable, Variable]) -> None: ...
    def _relabel_as_integers(self) -> collections.abc.Mapping[int, Variable]: ...
