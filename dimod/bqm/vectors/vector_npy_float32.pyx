...
ctypedef np.npy_float32 dtype


cdef class _Vector_npy_float32:
    ...
    def __getbuffer__(self, Py_buffer *buffer, int flags):
        ...
        buffer.format = 'f'  # needs to correspond to dtype
...
class Vector_npy_float32(_Vector_npy_float32, abc.MutableSequence):
    __slots__ = ()
