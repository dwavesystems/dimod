...
ctypedef np.npy_int16 dtype


cdef class _Vector_npy_int16:
    ...
    def __getbuffer__(self, Py_buffer *buffer, int flags):
        ...
        buffer.format = 'h'  # needs to correspond to dtype
...
class Vector_npy_int16(_Vector_npy_int16, abc.MutableSequence):
    __slots__ = ()
