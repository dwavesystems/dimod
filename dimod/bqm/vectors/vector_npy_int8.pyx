...
ctypedef np.npy_int8 dtype


cdef class _Vector_npy_int8:
    ...
    def __getbuffer__(self, Py_buffer *buffer, int flags):
        ...
        buffer.format = 'b'  # needs to correspond to dtype
...
class Vector_npy_int8(_Vector_npy_int8, abc.MutableSequence):
    __slots__ = ()
