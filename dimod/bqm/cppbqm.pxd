...
cdef extern from "dimod/adjmapbqm.h" namespace "dimod" nogil:
    ...
    cdef cppclass AdjMapBQM[V, B]:
        ...
        AdjMapBQM(np.uint32_t*, np.uint32_t*, np.uint32_t*, size_type, bool)
        AdjMapBQM(np.uint32_t*, np.uint32_t*, np.uint64_t*, size_type, bool)
        AdjMapBQM(np.uint32_t*, np.uint32_t*, np.int32_t*, size_type, bool)
        AdjMapBQM(np.uint32_t*, np.uint32_t*, np.int64_t*, size_type, bool)
        AdjMapBQM(np.uint32_t*, np.uint32_t*, np.float32_t*, size_type, bool)
        AdjMapBQM(np.uint32_t*, np.uint32_t*, np.float64_t*, size_type, bool)
        AdjMapBQM(np.uint64_t*, np.uint64_t*, np.uint32_t*, size_type, bool)
        AdjMapBQM(np.uint64_t*, np.uint64_t*, np.uint64_t*, size_type, bool)
        AdjMapBQM(np.uint64_t*, np.uint64_t*, np.int32_t*, size_type, bool)
        AdjMapBQM(np.uint64_t*, np.uint64_t*, np.int64_t*, size_type, bool)
        AdjMapBQM(np.uint64_t*, np.uint64_t*, np.float32_t*, size_type, bool)
        AdjMapBQM(np.uint64_t*, np.uint64_t*, np.float64_t*, size_type, bool)
        AdjMapBQM(np.int32_t*, np.int32_t*, np.uint32_t*, size_type, bool)
        AdjMapBQM(np.int32_t*, np.int32_t*, np.uint64_t*, size_type, bool)
        AdjMapBQM(np.int32_t*, np.int32_t*, np.int32_t*, size_type, bool)
        AdjMapBQM(np.int32_t*, np.int32_t*, np.int64_t*, size_type, bool)
        AdjMapBQM(np.int32_t*, np.int32_t*, np.float32_t*, size_type, bool)
        AdjMapBQM(np.int32_t*, np.int32_t*, np.float64_t*, size_type, bool)
        AdjMapBQM(np.int64_t*, np.int64_t*, np.uint32_t*, size_type, bool)
        AdjMapBQM(np.int64_t*, np.int64_t*, np.uint64_t*, size_type, bool)
        AdjMapBQM(np.int64_t*, np.int64_t*, np.int32_t*, size_type, bool)
        AdjMapBQM(np.int64_t*, np.int64_t*, np.int64_t*, size_type, bool)
