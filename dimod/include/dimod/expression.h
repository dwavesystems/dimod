 ...
 public:
    ...
    class ConstQuadraticIterator {
     public:
        ...
        const reference operator*() { return term_; }
    ...
    // todo: test mixins
    // void add_quadratic(std::initializer_list<index_type> row, std::initializer_list<index_type>
    // col,
    ...
    const std::vector<index_type>& variables() const;  // todo: iterator?
