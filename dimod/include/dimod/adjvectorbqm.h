...
class AdjVectorBQM {
  public:
    ...
    using invars_iterator = typename std::vector<std::pair<std::vector<std::pair<V, B>>, B>>::iterator;
    using const_invars_iterator = typename std::vector<std::pair<std::vector<std::pair<V, B>>, B>>::const_iterator;
