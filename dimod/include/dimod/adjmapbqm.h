...
class AdjMapBQM {
 public:
    ...
    utils::QuadraticProxy<AdjMapBQM> quadratic(variable_type u, variable_type v) {
        return {*this, u, v};
    }
    utils::QuadraticProxy<const AdjMapBQM> quadratic(variable_type u, variable_type v) const {
        return {*this, u, v};
    }
