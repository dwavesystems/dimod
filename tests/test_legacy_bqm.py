...
BQM_SUBCLASSES = [dimod.AdjDictBQM, dimod.AdjVectorBQM]


class DeprecatedBQMTestCase(unittest.TestCase):
    def setUp(self):
...
class TestAddOffset(DeprecatedBQMTestCase):
...
class TestAddVariablesFrom(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
...
class TestAddInteractionsFrom(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
    def test_iterable(self, name, BQM):
        if not BQM.shapeable():
            raise unittest.SkipTest
...
class TestAdjacency(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
...
class TestChangeVartype(DeprecatedBQMTestCase):
...
class TestConstruction(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
...
class TestContractVariables(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
...
class TestCoo(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
...
class TestCopy(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
...
class TestEmpty(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
    def test_binary(self, name, BQM):
        bqm = BQM.empty(dimod.BINARY)
...
class TestEnergies(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
...
class TestFileView(DeprecatedBQMTestCase):
...
class TestFixVariable(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
    def test_spin(self, name, BQM):
        if not BQM.shapeable():
            return
...
class TestFixVariables(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
    def test_typical(self, name, BQM):
        if not BQM.shapeable():
            return
...
class TestFlipVariable(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
    def test_binary(self, name, BQM):
...
class TestFromNumpyVectors(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
...
class TestFromQUBO(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
...
class TestGetLinear(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
...
class TestGetQuadratic(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
...
class TestHasVariable(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
    def test_typical(self, name, BQM):
...
class TestIteration(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
...
class TestLen(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
...
class TestNetworkxGraph(DeprecatedBQMTestCase):
...
class TestNumpyMatrix(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
...
class TestNormalize(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
...
class TestOffset(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
...
class TestPickle(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
...
class TestRemoveInteraction(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
    def test_basic(self, name, BQM):
        if not BQM.shapeable():
            raise unittest.SkipTest
...
class TestRemoveInteractionsFrom(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
    def test_basic(self, name, BQM):
        if not BQM.shapeable():
            raise unittest.SkipTest
...
class TestRemoveVariable(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
    def test_labelled(self, name, BQM):
        if not BQM.shapeable():
            raise unittest.SkipTest
...
class TestRelabel(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
...
class TestScale(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
    def test_exclusions(self, name, BQM):
        bqm = BQM({0: -2, 1: 2}, {(0, 1): -1}, 1., dimod.SPIN)
...
class TestSetLinear(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
    def test_basic(self, name, BQM):
...
class TestSetQuadratic(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
    def test_basic(self, name, BQM):
        # does not change shape
        bqm = BQM(np.triu(np.ones((3, 3))), dimod.BINARY)
...
class TestShape(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
    def test_3x3array(self, name, BQM):
...
class TestToIsing(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
    def test_spin(self, name, BQM):
        linear = {0: 7.1, 1: 103}
        quadratic = {(0, 1): .97}
...
class TestVartypeViews(DeprecatedBQMTestCase):
...
class TestToNumpyVectors(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
...
class TestToQUBO(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
    def test_binary(self, name, BQM):
        linear = {0: 0, 1: 0}
        quadratic = {(0, 1): 1}
...
class TestUpdate(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
...
class TestViews(DeprecatedBQMTestCase):
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_SUBCLASSES])
    ...
    @parameterized.expand([(cls.__name__, cls) for cls in BQM_CYTHON_SUBCLASSES])
    def test_quadratic_sum_cybqm2(self, name, BQM):
        # make sure it doesn't use python's sum
        bqm = BQM.from_ising({'a': -1, 'b': 2}, {'ab': -1, 'bc': 6})
...
class TestConstraint(DeprecatedBQMTestCase):
